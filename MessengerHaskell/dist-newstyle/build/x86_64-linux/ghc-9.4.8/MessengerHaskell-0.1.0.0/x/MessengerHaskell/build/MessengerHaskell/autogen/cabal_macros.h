...
/* package MessengerHaskell-0.1.0.0 */
#ifndef VERSION_MessengerHaskell
#define VERSION_MessengerHaskell "0.1.0.0"
#endif /* VERSION_MessengerHaskell */
#ifndef MIN_VERSION_MessengerHaskell
#define MIN_VERSION_MessengerHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_MessengerHaskell */
...
#define CURRENT_COMPONENT_ID "MessengerHaskell-0.1.0.0-inplace-MessengerHaskell"
